...
// File: contracts/interfaces/IBabyloniaLottery.sol
...
contract BabyloniaLottery is ReentrancyGuard, IBabyloniaLottery, Ownable {
     ...
     * @param _BABYTokenAddress: address of the BABY token
        ...
        nonReentrant
    {
        ...
        // Calculate prizes in BABY for each bracket by starting from the highest one
        ...
        // Transfer BABY to treasury address
