...
contract BNBICO1M1 is Ownable, ReentrancyGuard {
    ...
    uint256 public totalDepositedusdBalance;
    ...
    function Depositusd(uint256 _amount, uint256 _type) external nonReentrant {
        ...
        totalDepositedusdBalance = totalDepositedusdBalance + _amount.div(10 ** _tokenDecimals);
